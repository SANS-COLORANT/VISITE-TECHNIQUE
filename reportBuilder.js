...
async function habillerPdf(uriSource, config, siteFooter) {
  ...
  pages.forEach((page, index) => {
    ...
    // Small standalone spiral from the Word template on every interior page.
    if (pageMarkImage) {
