...
function Header({ title, subtitle, onBack, action, onAction }) {
  return <View style={{paddingHorizontal:18,paddingTop:14,paddingBottom:10}}><View style={{flexDirection:'row',alignItems:'center',gap:10}}>
    {onBack?<TouchableOpacity accessibilityRole="button" accessibilityLabel="Retour" onPress={onBack} style={{paddingVertical:8,paddingRight:4}}><CvcIcon name="chevron-left" size={23} color={COLORS.orangeDark} strokeWidth={2.1} /></TouchableOpacity>:null}
