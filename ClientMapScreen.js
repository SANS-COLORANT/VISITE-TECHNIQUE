        ...
        {selection ? (
          <View style={{ marginTop: 12, padding: 14, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.82)', borderWidth: 1, borderColor: 'rgba(22,21,15,0.1)' }}>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }}>
              <TouchableOpacity style={styles.btnPrimary} onPress={() => navigation.navigate('SiteLocals', { siteId: selection.id, nomSite: selection.nom_site, clientId, nomClient })}><ButtonGlow /><Text style={styles.btnPrimaryText}>Ouvrir le site</Text></TouchableOpacity>
