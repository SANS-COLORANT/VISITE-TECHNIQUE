...
const BASE = Object.freeze({
  diagnostic: [
    ...
    doc('inventaire', 'Inventaire équipements existant', 'inventory', 'Conserver la source et tracer les écarts terrain.'),
...
const OVERRIDES = Object.freeze({
  ...
  opr_reception: [
    doc('liste_opr', 'Liste des ouvrages / prestations à contrôler', 'opr_list'),
  ],
  levee_reserves: [
  ...
  inventaire_passation: [
    doc('inventaire_attendu', 'Inventaire attendu avant passation', 'inventory'),
  ],
  audit_multisites: [
    doc('synthese_sites', 'Synthèse / liste des sites', 'campaign_list'),
  ],
  ...
  controle_sanitaire: [
    doc('reference_sanitaire', 'Références / analyses sanitaires utiles', 'sanitary_analysis'),
  ],
});
