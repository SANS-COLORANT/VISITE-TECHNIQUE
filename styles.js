...
export const styles = StyleSheet.create({
  ...
  catalogueFilters: { paddingHorizontal: 20, paddingVertical: 10, gap: 7 },
  catalogueFilter: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 18, borderWidth: 1, borderColor: COLORS.line, backgroundColor: COLORS.white },
  catalogueFilterActive: { backgroundColor: COLORS.orange, borderColor: COLORS.orange },
  catalogueFilterText: { fontSize: 11.5, color: COLORS.inkSoft, fontWeight: '600' },
  ...
  catalogueChoice: { paddingHorizontal: 10, paddingVertical: 7, borderRadius: 16, borderWidth: 1, borderColor: COLORS.line, backgroundColor: COLORS.white },
