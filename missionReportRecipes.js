...
const OVERRIDES = Object.freeze({
  ...
  diagnostic_chaufferie_ss: {
    ...
    titles: {
      architecture: 'Production, circuits et architecture hydraulique',
      mesures: 'Fonctionnement, mesures et réglages'
    }
  },
  diagnostic_ecs: {
    label: 'Rapport de diagnostic / audit ECS',
    titles: {
      architecture: 'Production, stockage, distribution et bouclage',
      mesures: 'Températures, débits et relevés ECS'
    }
  },
  diagnostic_climatisation_pac: {
    label: 'Rapport de diagnostic climatisation / PAC',
    titles: {
      architecture: 'Architecture UE / UI / réseaux',
      mesures: 'Fonctionnement et relevés climatisation / PAC'
    }
  },
  diagnostic_gtb: {
    label: 'Rapport de diagnostic régulation / GTB / GTC',
    titles: {
      architecture: 'Architecture fonctionnelle et communications',
      essais: 'Essais de régulation / communication'
    }
  },
  diagnostic_cible: {
