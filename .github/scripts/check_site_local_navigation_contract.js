...
requireText(locals, 'FROM installations i', 'liste des locaux réels');
requireText(locals, 'visit_count', 'compteur de visites par local');
...
requireText(visits, 'listerVisitesLocal', 'historique filtré au local');
