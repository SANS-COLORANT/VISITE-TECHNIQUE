...
requireText(read('missionClientExcelExport.js'), "'03_Reserves'", 'dedicated reserve worksheet');
requireText(read('missionClientExcelExport.js'), "'04_Inventaire'", 'client inventory worksheet');
requireText(read('missionClientExcelExport.js'), "'05_Mesures'", 'client measures worksheet');
