...
expect(sites.includes('listerAppartenancesClient'), 'Le tri Lot / groupe doit utiliser les appartenances réelles des sites.');
...
expect(memory.includes('scrollOffsets = new Map()'), 'La mémoire de navigation doit rester légère et en mémoire, sans migration SQLite.');
