...
console.log(`Intranet LOCAL name sync contract validated: imported LOCAL designation is persisted, migration v34 remains registered under schema v${schemaVersion}, and future link/name refreshes update the METRA installation without replacing it with an empty name.`);
