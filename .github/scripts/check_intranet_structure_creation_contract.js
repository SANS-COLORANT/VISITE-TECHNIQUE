...
// (Missions utilise désormais v40-v42) sans réutiliser ni modifier 35 -> 39.
requireText(constants, 'DATABASE_SCHEMA_VERSION = 42', 'current global schema version 42');
...
requireRegex(migrations, /migration037\s*,\s*migration038\s*,\s*migration039\s*,\s*migration040[\s\S]*migration041[\s\S]*migration042/, 'migration ordering 37 -> 38 -> 39 -> 40 -> 41 -> 42');
...
console.log('Intranet site/local creation contract validated: immutable SQLite lineage 35->36->37->38->39 is preserved, while the global application schema advances additively to v42 for Missions.');
