...
requireText(
  ...
  'lazy persistent equipment helper'
);
...
requireText(
  ...
  'lazy equipment history export binding'
);
...
console.log(
  'Startup dependency graph contract validated: Home avoids deletion/XLSX modules, db.js defers heavy data repositories with all exported bindings intact, and SQLite startup PRAGMAs use one native bridge call.'
);
