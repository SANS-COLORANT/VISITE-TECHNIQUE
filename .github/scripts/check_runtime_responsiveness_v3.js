...
requireText(docs,"function chargerExportClient(){return require('./clientBatchExport.js');}",'lazy client export module');
forbidText(docs,"from './clientBatchExport.js';",'eager client batch export graph');
