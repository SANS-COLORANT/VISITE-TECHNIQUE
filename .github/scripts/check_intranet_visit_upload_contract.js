...
requireText(photoOutbox, 'i += 3', 'three-photo concurrency');
...
console.log('Intranet visit upload contract validated: exact visit POST plus separate idempotent multipart photo upload, DPoP retries, persistent outboxes, Offline/Online status, conflicts, structural criteria validation and full material safeguards.');
