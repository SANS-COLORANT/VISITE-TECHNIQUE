...
requireText(ui, 'Confirmer le remplacement et envoyer', 'partial material replacement disclosure');
...
console.log('Intranet visit upload contract validated: exact POST, idempotent outbox, offline/auth retry separation, conflicts, structural criteria validation, full material safeguards and explicit unsupported photo/conclusion scope.');
