...
forbidText(payload, 'conclusion:', 'conclusion excluded from visit JSON contract');
...
requireText(docs, 'Le JSON de visite reste strictement sans photo', 'visit JSON remains photo-free');
...
console.log('Intranet visit upload contract validated: exact visit POST, imported-client ownership before HTTP, idempotent outbox, Offline/Online status, conflicts, structural criteria validation, full material safeguards and separate photo route.');
