...
const E = (id, label, group, iconType, keywords = '') => ({
  id,
  label,
  defaultLabel: label,
  group,
...
export const HYDRAULIC_EQUIPMENT_TYPES = Object.freeze([
  ...
  E(
    ...
    'Hydraulique',
    'hydraulic_separator',
    'bouteille découplage casse pression'
  ),
  ...
  E(
    ...
    'Hydraulique',
    'expansion_vessel',
    'maintien pression expansion automatique'
  ),
  ...
  E(
    ...
    'Hydraulique',
    'hydraulic_separator',
    'manchette flexible antivibratile'
  ),
  ...
  E(
    ...
    'Robinetterie',
    'three_way_valve',
    '3 voies trois voies motorisée mélangeuse'
  ),
  ...
  E(
    ...
    'Mesure',
    'thermometer',
    'sonde température départ retour extérieure'
  ),
  ...
  E(
    ...
    'Mesure',
    'pressure_gauge',
    'pression différentielle delta p'
  ),
  ...
  E(
    ...
    'Aéraulique',
    'heat_exchanger',
    'récupérateur chaleur double flux'
  ),
  ...
  E(
    ...
    'vmc_box',
    'armoire électrique tgbt coffret'
  ),
  ...
  E(
    ...
    'Électricité / Régulation',
    'vmc_box',
    'variateur vitesse fréquence vfd'
  ),
...
export const HYDRAULIC_PORTS_BY_TYPE = Object.freeze(
  Object.fromEntries(HYDRAULIC_EQUIPMENT_TYPES.map((item) => [item.id, hydraulicPorts(item.id)]))
);
...
export function mapMaterialToHydraulicType(material = {}) {
  const text = norm(
    [material.categorie, material.designation, material.marque, material.modele].filter(Boolean).join(' ')
  );
  const rules = [
    [['chaudiere'], 'boiler'],
    [['bruleur'], 'burner'],
    [['pac ', 'pompe a chaleur'], 'heat_pump_air_water'],
    [['groupe froid', 'chiller'], 'chiller'],
    [['pompe double', 'pompe jumel'], 'twin_pump'],
    [['circulateur'], 'circulator'],
    [['pompe de bouclage', 'bouclage ecs'], 'recirculation_pump'],
    [['pompe'], 'pump'],
    [['echangeur'], 'heat_exchanger'],
    [['bouteille', 'decoupl'], 'hydraulic_separator'],
    [['collecteur', 'nourrice'], 'manifold'],
    [['ballon tampon'], 'buffer_tank'],
    [['ballon ecs', 'preparateur ecs'], 'dhw_tank'],
    [['vase', 'expansion'], 'expansion_vessel'],
    [['desemboueur', 'pot a boue'], 'dirt_separator'],
    [['adoucisseur'], 'softener'],
    [['disconnecteur'], 'backflow_preventer'],
    [['detendeur', 'reducteur de pression'], 'pressure_reducing_valve'],
    [['clapet anti retour'], 'check_valve'],
    [['soupape'], 'safety_valve'],
    [['vanne 3', 'vanne trois', 'melangeuse', 'mitigeur'], 'three_way_valve'],
    [['vanne 2', 'vanne deux'], 'two_way_valve'],
    [['equilibrage'], 'balancing_valve'],
    [['vanne', 'robinetterie'], 'shutoff_valve'],
    [['compteur energie', 'calorimet'], 'energy_meter'],
    [['compteur gaz'], 'gas_meter'],
    [['compteur', 'debitmetre'], 'water_meter'],
    [['manometre'], 'pressure_gauge'],
    [['thermometre', 'sonde temperature'], 'thermometer'],
    [['caisson', 'vmc'], 'vmc_box'],
    [['ventilateur'], 'fan'],
    [['extracteur'], 'extractor'],
    [['registre'], 'duct_damper'],
    [['clapet coupe feu'], 'fire_damper'],
    [['filtre air'], 'air_filter'],
    [['armoire electrique'], 'electrical_cabinet'],
    [['coffret'], 'control_panel'],
    [['regulateur', 'automate'], 'controller'],
    [['servomoteur'], 'actuator'],
    [['variateur'], 'frequency_drive'],
    [['filtre'], 'y_filter'],
    [['purgeur'], 'air_vent'],
    [['fuite'], 'water_leak']
  ];
