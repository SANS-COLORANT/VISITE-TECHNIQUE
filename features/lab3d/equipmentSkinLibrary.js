...
export const LAB3D_SKIN_LIBRARY = Object.freeze([
  ...
  {
    key: 'viessmann-boiler',
    label: 'Viessmann · chaudière',
    brand: 'Viessmann',
    types: ['chaudiere'],
    primary: '#F2F2F0',
    secondary: '#DADBD8',
    accent: '#D71920',
    dark: '#4B4E50',
    variant: 'boiler_cabinet',
    modelHints: ['vitodens', 'vitocrossal', 'vitoplex']
  },
  {
    key: 'dedietrich-boiler',
    label: 'De Dietrich · chaudière',
    brand: 'De Dietrich',
    types: ['chaudiere'],
    primary: '#E7E7E4',
    secondary: '#C9CAC8',
    accent: '#C9342E',
    dark: '#36383A',
    variant: 'boiler_floor',
    modelHints: ['c 230', 'c230', 'c 310', 'c310', 'c 340', 'c340', 'gas']
  },
  {
    key: 'atlantic-boiler',
    label: 'Atlantic · chaudière',
    brand: 'Atlantic',
    types: ['chaudiere'],
    primary: '#F0F2F3',
    secondary: '#DDE3E6',
    ...
    dark: '#334653',
    variant: 'boiler_cabinet',
    modelHints: ['varfree', 'condensinox', 'varmax']
  },
  {
    key: 'bosch-boiler',
    label: 'Bosch · chaudière',
    brand: 'Bosch',
    types: ['chaudiere'],
    primary: '#ECEEEE',
    secondary: '#D4D8D9',
    ...
    dark: '#42484B',
    variant: 'boiler_cabinet',
    modelHints: ['condens', 'uni']
  },

  {
    key: 'grundfos-pump',
    label: 'Grundfos · pompe',
    brand: 'Grundfos',
    types: ['pompe'],
    primary: '#D13C33',
    secondary: '#5D6266',
  ...
  },
  {
    ...
    dark: '#202A33',
    variant: 'pump_inline',
    modelHints: ['etaline', 'etanorm', 'calio']
  },
  {
    key: 'lowara-pump',
    label: 'Lowara · pompe',
    ...
    dark: '#29333B',
    variant: 'pump_inline',
    modelHints: ['ecocirc', 'e sh', 'e ns']
  },

  {
    key: 'weishaupt-burner',
    label: 'Weishaupt · générateur',
    brand: 'Weishaupt',
    types: ['chaudiere', 'equipement'],
    primary: '#ECECEC',
    secondary: '#BBC1C4',
    accent: '#EA7D25',
    dark: '#33404A',
    variant: 'boiler_burner',
    modelHints: ['wm', 'wk', 'wg', 'wl']
  },

  {
    key: 'danfoss-hydronic',
    label: 'Danfoss · hydraulique',
    brand: 'Danfoss',
    types: ['equipement', 'echangeur'],
    primary: '#D9DDE0',
    secondary: '#AEB6BC',
    accent: '#C52828',
    dark: '#30383E',
  ...
  {
    key: 'siemens-cabinet',
    label: 'Siemens · armoire',
    brand: 'Siemens',
    types: ['armoire', 'equipement'],
    primary: '#D9DEDF',
    secondary: '#B9C0C2',
    accent: '#179B9B',
    dark: '#364246',
  ...
  {
    key: 'schneider-cabinet',
    label: 'Schneider Electric · armoire',
  ...
  {
    key: 'atlantic-air',
    label: 'Atlantic · CTA / VMC',
    brand: 'Atlantic',
    types: ['cta', 'vmc', 'ventilateur'],
    primary: '#D8E2E7',
    secondary: '#AFC0C9',
    accent: '#376C9B',
    dark: '#334653',
  ...
  {
    key: 'generic-cylinder',
    label: 'Ballon / vase générique',
    brand: 'Générique',
    types: ['ballon', 'vase_expansion', 'bouteille', 'adoucisseur', 'bac_sel'],
    primary: '#7F93B6',
    secondary: '#60708C',
    accent: '#D9E4F1',
    dark: '#364456',
  ...
  {
    key: 'generic-exchanger',
    label: 'Échangeur générique',
    brand: 'Générique',
    types: ['echangeur'],
    primary: '#BFA658',
    secondary: '#807348',
