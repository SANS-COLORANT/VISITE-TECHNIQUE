...
const RAW_BASE =
  'https://raw.githubusercontent.com/SANS-COLORANT/VISITE-TECHNIQUE/3af148f5a3793e64634629d56f7fac1dd466e6c9/assets/brands';
...
const BRAND_PROFILES = {
  grundfos: { color: '#005696', display: 'GRUNDFOS', size: 19, style: { fontWeight: '900', letterSpacing: -0.45 } },
  wilo: {
    color: '#009B67',
    display: 'wilo',
    size: 24,
    style: { fontWeight: '900', fontStyle: 'italic', letterSpacing: -0.55 }
  },
  lowara: { color: '#4A5560', display: 'Lowara', size: 22, style: { fontWeight: '800', fontStyle: 'italic' } },
  ksb: { color: '#00549F', display: 'KSB', size: 22, style: { fontWeight: '900', letterSpacing: 0.8 } },
  ...
  viessmann: { color: '#F26A21', display: 'VIESSMANN', size: 18, style: { fontWeight: '900', letterSpacing: -0.4 } },
  atlantic: { color: '#6840A8', display: 'ATLANTIC', size: 21, style: { fontWeight: '900', letterSpacing: 0.35 } },
  chappee: { color: '#D71920', display: 'CHAPPÉE', size: 19, style: { fontWeight: '900', letterSpacing: 0.35 } },
  bosch: { color: '#D71920', display: 'BOSCH', size: 20, style: { fontWeight: '900', letterSpacing: 0.55 } },
  ...
  'alfa laval': { color: '#1B365D', display: 'ALFA LAVAL', size: 16, style: { fontWeight: '900', letterSpacing: 0.9 } },
  ...
  zilmet: { color: '#275EB2', display: 'ZILMET', size: 18, style: { fontWeight: '900', letterSpacing: 0.8 } },
  ...
  fernox: { color: '#34323A', display: 'FERNOX', size: 19, style: { fontWeight: '900', letterSpacing: 0.8 } },
  spirotech: { color: '#F2A900', display: 'Spirotech', size: 18, style: { fontWeight: '800' } },
  caleffi: { color: '#009A44', display: 'CALEFFI', size: 18, style: { fontWeight: '900', letterSpacing: 0.8 } },
  ...
  sofrel: { color: '#3565B0', display: 'SOFREL', size: 20, style: { fontWeight: '900', letterSpacing: 0.7 } },
  ...
  sauter: { color: '#147DB0', display: 'SAUTER', size: 19, style: { fontWeight: '900', letterSpacing: 0.75 } },
  belimo: { color: '#0057A6', display: 'BELIMO', size: 20, style: { fontWeight: '900', letterSpacing: 0.9 } },
  ...
  daikin: {
    ...
    display: 'DAIKIN',
    size: 20,
    style: { fontWeight: '900', fontStyle: 'italic', letterSpacing: 0.5 }
  },
  ...
  trane: { color: '#00549E', display: 'TRANE', size: 20, style: { fontWeight: '900', letterSpacing: 0.65 } },
  carrier: { color: '#00529B', display: 'Carrier', size: 20, style: { fontWeight: '800', fontStyle: 'italic' } },
  aldes: { color: '#005AA9', display: 'ALDES', size: 21, style: { fontWeight: '900', letterSpacing: 0.7 } },
  ...
  return (
    <View style={{ width, height, alignItems: 'center', justifyContent: 'center' }}>
      <Image
        source={source}
        resizeMode="contain"
        style={{ position: 'absolute', width: width + 4, height: height + 4, tintColor: '#FFFFFF', opacity: 0.96 }}
        onError={onError}
      />
      <Image source={source} resizeMode="contain" style={{ width, height }} onError={onError} />
    </View>
  );
}
  ...
  if (onColor) {
    return (
      <View style={{ width: boxW, height: boxH, alignItems: 'center', justifyContent: 'center' }}>
        <Wordmark nom={nom} compact={compact} onColor />
      </View>
    );
  }
  ...
  return (
    <View
      style={[
        ...
        { width: boxW, height: boxH, borderRadius: 10 }
      ]}
    >
