...
export function PreAllumagePhotoButton({ visiteId, entiteKey, label, style, beforeCapture }) {
  ...
  return <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
    ...
    <PhotoButton visiteId={visiteId} entiteKey={entiteKey} label={label} style={style} beforeCapture={beforeCapture} onPhotoSaved={charger} />
  </View>;
}
