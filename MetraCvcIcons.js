...
function CvcIcon({ name, size = 36, color = '#10384B', strokeWidth = 1.9 }) {
  ...
  if (key === 'tools' || key === 'equipment') {
    ...
    body = <G {...p}>
      ...
      <Path d="M14 12.4c-.4-3 .6-5.6 3.2-6.2 1.6 1.8.3 4.8-3.2 6.2Z" />
      <Path d="M15.5 14.8c2.8 1.1 4.5 3.3 3.7 5.8-2.4.5-4.3-2.1-3.7-5.8Z" />
      <Path d="M12.5 14.8c-2.4 1.9-5.1 2.3-6.9.4.8-2.3 4-2.6 6.9-.4Z" />
    </G>;
  } else if (key === 'flame' || key === 'ignition') {
    body = <G {...p}>
      <Path d="M14 3.5c2.6 3.8 6.8 6.6 6.8 12a6.8 6.8 0 0 1-13.6 0c0-2.8 1.3-4.6 2.8-6 0 2.6 1.2 4 2.6 4 0-3.8-1-6.2 1.4-10Z" />
      <Path d="M14 24.5a2.9 2.9 0 0 1-2.9-2.9c0-1.8 1.5-2.8 2.9-4.6 1.4 1.8 2.9 2.8 2.9 4.6a2.9 2.9 0 0 1-2.9 2.9Z" />
    </G>;
  ...
  } else if (key === 'chevron-left') {
    body = <G {...p}><Path d="M17 5.5 9.5 14l7.5 8.5" /></G>;
  } else if (key === 'chevron-right') {
    body = <G {...p}><Path d="M11 5.5 18.5 14 11 22.5" /></G>;
