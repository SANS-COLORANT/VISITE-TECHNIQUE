...
function CvcIcon({ name, size = 36, color = '#10384B', strokeWidth = 1.9 }) {
  ...
  if (key === 'tools' || key === 'equipment') {
    ...
    body = (
      <G {...p}>
        <Path d="M3.5 14s3.8-6.5 10.5-6.5S24.5 14 24.5 14 20.7 20.5 14 20.5 3.5 14 3.5 14Z" />
    ...
    body = (
      <G {...p}>
        <Path d="M6.5 8h15" />
        <Path d="M10 8V5h8v3" />
        <Path d="M8.2 8 9.3 24h9.4l1.1-16" />
        <Line x1="12" y1="12" x2="12.6" y2="20" />
        <Line x1="16" y1="12" x2="15.4" y2="20" />
      </G>
    );
