...
const EXTRA_MODELS = [
  ...
  [
    ...
    'https://api.grundfos.com/literature/Grundfosliterature-1322.pdf',
    'verified_range'
  ],
  [
    'Circulateur',
    'Grundfos',
    'ALPHA3',
    'Circulateur domestique communicant',
    'https://api.grundfos.com/literature/Grundfosliterature-1322.pdf',
    'verified_range'
  ],
  [
    ...
    'Grundfos',
    'UPS2',
    'Circulateur haut rendement de remplacement',
    'https://api.grundfos.com/literature/Grundfosliterature-1322.pdf',
    'verified_range'
  ],
  [
    ...
    'Grundfos',
    'TPE2',
    'Pompe in-line à vitesse variable',
    'https://www.grundfos.com/fr/campaign/new-tpe3',
    'verified_range'
  ],
  [
    'Pompe',
  ...
  [
    ...
    'Grundfos',
    'NBE / NBGE',
    'Pompe normalisée à moteur IE5 / vitesse variable',
    'https://api.grundfos.com/literature/Grundfosliterature-1322.pdf',
    'verified_range'
  ],
  [
    ...
    'Grundfos',
    'NB / NBG',
    'Pompe normalisée monocellulaire',
    'https://api.grundfos.com/literature/Grundfosliterature-1322.pdf',
    'verified_range'
  ],
  [
  ...
  [
    ...
    'Wilo',
    'Stratos MAXO-D',
    'Circulateur double intelligent',
    'https://wilo.com/fr/fr/Produits-Applications/fr/produits',
    'verified_range'
  ],
  [
    'Circulateur',
  ...
  [
    ...
    'Wilo',
    'Yonos MAXO-D',
    'Circulateur double haut rendement',
    'https://wilo.com/fr/fr/Produits-Applications/fr/produits',
    'verified_range'
  ],
  [
    ...
    'Wilo',
    'Yonos MAXO-Z',
    'Circulateur ECS haut rendement',
    'https://wilo.com/fr/fr/Produits-Applications/fr/produits',
    'verified_range'
  ],
  [
  ...
  [
    ...
    'Wilo',
    'Stratos GIGA2.0-D',
    'Pompe double en ligne intelligente',
    'https://wilo.com/fr/fr/Produits-Applications/fr/produits',
    'verified_range'
  ],
  [
  ...
  [
    ...
    'Wilo',
    'Yonos GIGA-N',
    'Pompe normalisée à vitesse variable',
    'https://wilo.com/fr/fr/Produits-Applications/fr/produits',
    'verified_range'
  ],
  [
  ...
  [
    ...
    'Wilo',
    'CronoBloc-BL-E',
    'Pompe monobloc à vitesse variable',
    'https://wilo.com/fr/fr/Produits-Applications/fr/produits',
    'verified_range'
  ],
  ...
  [
    ...
    'Viessmann',
    'Vitocrossal 100 CIB',
    'Chaudière gaz condensation 80 à 318 kW',
    'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitocrossal.html',
    'verified'
  ],
  [
    'Chaudière',
    ...
    'Chaudière gaz condensation 787 à 1400 kW',
    'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitocrossal.html',
    'verified'
  ],
  [
    ...
    'Viessmann',
    'Vitocrossal 200 CRU',
    'Chaudière gaz condensation 800 à 1000 kW',
    'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitocrossal.html',
    'verified'
  ],
  [
    ...
    'Viessmann',
    'Vitodens 200-W',
    'Chaudière murale gaz condensation 1,9 à 32 kW',
    'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitodens.html',
    'verified'
  ],
  [
    'Chaudière',
    'Viessmann',
    'Vitodens 100-W',
    'Chaudière murale gaz condensation 3,2 à 32 kW',
    'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitodens.html',
    'verified'
  ],
  [
    ...
    'Viessmann',
    'Vitoplex 200',
    'Chaudière basse température grande puissance',
    'https://www.viessmann.fr/fr/services-et-assistance/archives-produits/vitola.html',
    'verified_range'
  ],
  [
    'Chaudière',
  ...
  [
    ...
    'Spirotech',
    'SpiroCross',
    'Séparateur hydraulique combiné air/boues',
    'https://www.spirotech.com',
    'verified_range'
  ],
...
const EXTRA_VARIANTS = [
  ...
  ...[
    ...
    model: 'TPE3',
    name: `TPE3 ${n}`,
    source: 'https://www.grundfos.com/fr/support/how-to-guides/get-verified-data-for-sustainable-building-design',
    quality: 'verified_range',
    specs: [
      ['DN', n.split('-')[0], ''],
      ['Classe hauteur', n.split('-')[1], 'dm']
    ]
  })),
  // Viessmann Vitocrossal 100 CIB - puissances de gamme documentées 80-318 kW, variantes représentatives
  ...[80, 120, 160, 200, 240, 280, 318].map((p) => ({
    brand: 'Viessmann',
    model: 'Vitocrossal 100 CIB',
    name: `Vitocrossal 100 CIB ${p}`,
    source: 'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitocrossal.html',
    quality: 'verified_range',
    specs: [
      ['Puissance classe', String(p), 'kW'],
      ['Technologie', 'Condensation gaz', '']
    ]
  })),
  ...
  ...[19, 25, 32].map((p) => ({
    ...
    name: `Vitodens 200-W ${p} kW`,
    source: 'https://www.viessmann.fr/fr/produits/chauffage-gaz/gamme-vitodens.html',
    quality: 'verified_range',
    specs: [
      ['Puissance max', String(p), 'kW'],
      ['Type', 'Murale condensation', '']
    ]
  }))
];
    ...
    if (!existing) {
      await db.runAsync(
        ...
        [
          ...
          nom,
          description,
          `${categorie} ${marque} ${nom} ${description}`,
          source || null,
          quality || 'catalogue',
