  ...
  travaux_chantier: {
    ...
    sections: [
      section('avancement', 'Avancement', [
        field('niveau_avancement', 'État général des travaux', 'choice', 'rapide', [
          'Non commencé',
          'En cours',
  ...
  suivi_ponctuel: {
    ...
    sections: [
      section('sujet', 'Sujet suivi', [
        field('etat_sujet', 'Évolution depuis le dernier point', 'choice', 'rapide', [
          'Inchangé',
          'Amélioré',
  ...
  conformite_reglementaire: {
    ...
    sections: [
      section('controle', 'Contrôle ciblé', [
        field('resultat', 'Résultat global du contrôle', 'choice', 'rapide', [
          'Conforme',
          'Non conforme',
          'À contrôler',
          'Non vérifiable',
        ...
        field('contre_visite', 'Contre-visite / contrôle ultérieur nécessaire', 'choice', 'expert', [
          'Oui',
          'Non',
          'À décider'
        ])
  ...
  opr_reception: {
    ...
    sections: [
      ...
      section('opr_reception', 'Réception', [
        field('etat_reception', 'État proposé : réception / réserves / report', 'choice', 'rapide', [
          'Réceptionnable',
          'Réceptionnable avec réserves',
          'À reporter',
          'À confirmer'
        ]),
  ...
  levee_reserves: {
    ...
    sections: [
      section('levee', 'Recontrôle', [
        ...
        field('resultat', 'Résultat', 'choice', 'rapide', [
          'Levée',
          'Maintenue',
          'Partiellement levée',
          'Inaccessible',
  ...
  preallumage_reprise_saison: {
    ...
    sections: [
      section('saison_installation', 'Installation', [
        field('disponibilite', 'Installation disponible / état avant démarrage', 'choice', 'rapide', [
          'Prête',
          'Partiellement prête',
          'Non prête',
          'Non vérifiable'
